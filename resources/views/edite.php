...
<body>
  ...
  <form action="{{ route('products.update') }}" enctype="multipart/form-data" method="POST" class="p-24 w-[50%] justify-center mx-auto">
    @csrf
    ...
    <div class="mb-5">
      ...
      <op id="category" name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">

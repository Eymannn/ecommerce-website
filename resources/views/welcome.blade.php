        ...
        <nav id="header" class="w-full z-30 top-0 py-1">
            <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
                ...
                <div class="order-2 md:order-3 flex items-center" id="nav-content">
                   @auth
                       <a class="inline-block no-underline hover:text-black" href="{{ route('show.profile', ['id' => auth()->id()]) }}">
                   ...
                   @endauth 
                    ...
                    <a class="pl-3 inline-block no-underline hover:text-black" href="{{ route('card') }}">
                        <svg class="fill-current hover:text-black" xmlns="http://www.w3.org/2000/svg" width="24"
                            height="24" viewBox="0 0 24 24">
                            <path
                    ...
                    <a href="{{ route('favorites') }}" class="pl-3 inline-block no-underline hover:text-black">
                ...
                @foreach ($products as $product)
                    <div
                        ...
                        <a href="{{  route('product-page', ['id' => $product->id]) }}">
                               ...
                               <img class="hover:grow hover:shadow-lg w-60 mb-3 "
                                src="{{ $product->getFirstMediaUrl('products') }}">
                            
                            <div class="pt-3 flex items-center justify-between">
                                <div><p class="">{{ $product->name }}</p></div>
                                 <div>
        ...
        <section class="bg-white py-8 px-6">
            ...
            <div class="flex flex-col md:grid md:grid-cols-3 gap-3">
                ...
                <div class="relative rounded overflow-hidden">
                    <a href="{{ route('product-by-category', ['category' => 'Phones']) }}">
                        <img src="/images/1.jpg" alt="Hanging Planters" class="w-full">
                        <p
                ...
                <div class="relative rounded overflow-hidden">
                    <a href="{{ route('product-by-category', ['category' => 'Tv']) }}">
                        <img src="/images/2.jpg" alt="Hanging Planters" class="w-full">
                        <p
                            class="cursor-pointer absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-2xl text-center text-white font-roboto font-medium group-hover:bg-opacity-60 transition">
                            Tv's
                        </p>
                ...
                <div class="relative rounded overflow-hidden">
                    <a href="{{ route('product-by-category', ['category' => 'Computers']) }}">
                        <img src="/images/3.webp" alt="Hanging Planters" class="w-full">
                        <p
                            class="cursor-pointer absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-2xl text-center text-white font-roboto font-medium group-hover:bg-opacity-60 transition">
                            Computer
                        </p>
                ...
                <div class="relative rounded overflow-hidden">
                    <a href="{{ route('product-by-category', ['category' => 'HeadPhones']) }}">
                        <img src="/images/4.webp" alt="Hanging Planters" class="w-full">
                        <p
                            class="cursor-pointer absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-2xl text-center text-white font-roboto font-medium group-hover:bg-opacity-60 transition">
                            HeadPhones
                        </p>
                ...
                <div class="relative rounded overflow-hidden">
                    <a href="{{ route('product-by-category', ['category' => 'Books']) }}">
                        <img src="/images/23.jpg" alt="Hanging Planters" class="w-full">
                        <p
                            class="cursor-pointer absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-2xl text-center text-white font-roboto font-medium group-hover:bg-opacity-60 transition">
                            Books
                        </p>
                ...
                <div class="relative rounded overflow-hidden">
                    <a href="{{ route('product-by-category', ['category' => 'Photographie']) }}">
                        <img src="/images/53.avif" alt="Hanging Planters" class="w-full">
                        <p
                            class="cursor-pointer absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-2xl text-center text-white font-roboto font-medium group-hover:bg-opacity-60 transition">
                            Photographie
                        </p>
        ...
        <section class="bg-white py-8" id="about">
            ...
            <div class="container py-8 px-6 mx-auto">
                ...
                <p class="mb-8">Lorem ipsum dolor sit amet, consectetur <a href="#">random link</a> adipiscing
                    ...
                    fringilla ut. Gravida rutrum quisque non Ayman orci ac auctor augue mauris. Accumsan lacus vel
                    ...
                    <div class="flex w-full lg:w-1/2 ">
                        <div class="px-3 md:px-0">
                            ...
                            <p class="py-4">
                                ...
                                if you want or need anything just call me and i'll be there for you forever don't any of you forget that.
                            </p>
                        </div>
                    </div>
                    <div class="flex w-full lg:w-1/2 lg:justify-end lg:text-right mt-6 md:mt-0">
                        <div class="px-3 md:px-0">
                            ...
                            <div class="w-full flex items-center py-4 mt-0">
                                ...
                                <a href="https://www.instagram.com/aymannelm" class="mx-2">
                                    <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
                                        <path
